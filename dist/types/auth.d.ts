 ...
 */
export type AdminRole = 'super_admin' | 'admin' | 'moderator' | 'editor' | 'event_manager' | 'contributor' | 'member' | 'viewer';
/**
...
export declare function isAdminUser(obj: unknown): obj is AdminUser;
export declare function isValidAdminRole(role: string): role is AdminRole;
export declare function hasHigherRole(userRole: AdminRole, targetRole: AdminRole): boolean;
export declare function hasEqualOrHigherRole(userRole: AdminRole, targetRole: AdminRole): boolean;
